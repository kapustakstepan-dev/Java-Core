...
public class Main {
    public static void main(String[] args) {
        ...
        profe1.ponerNotas(borja);
        System.out.println("Este es expediente de Borja");
        borja.mostrarExpediente();
        //System.out.printf("La media del alumno es %.2f\n", profe1.calcularMedia(borja));#

        System.out.println("Calificando ");
        for (Alumno alumno : listaAlumnos){
            profe1.ponerNotas(alumno);
        }
        ...
        //System.out.println("La calificacion de la asignatura es " + a1.getCalificacion());
        //System.out.println("La calificacion de la asignatura es " + a2.getCalificacion());
