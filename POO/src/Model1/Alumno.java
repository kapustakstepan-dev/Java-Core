...
public class Alumno {
    ...
    public void mostrarExpediente(){
        System.out.println("Mostarando expediente:");
        System.out.println("Asignatura 1: "+asignatura1.getCalificacion());
        System.out.println("Asignatura 2: "+asignatura2.getCalificacion());
        System.out.println("Asignatura 3: "+asignatura3.getCalificacion());
    }
